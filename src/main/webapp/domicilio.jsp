...
<body>
	...
	<c:set var="listPlatos" value="${sManager.getListPlatos()}" />
		...
		<div class="form-check">
				...
				<label class="form-check-label"
					for="flexCheckDefault" style="margin-left: 10px"> numero de platos </label>
				<label class="form-check-label"
					for="flexCheckDefault" style="margin-left: 65px">platos </label>
			</div>
		<c:forEach items="${listPlatos}" var="i">
			...
			<div class="form-check">
				...
				<input name="${i.idPlato}" type="number" min="1" step="1" value=""
            ...
            <div class="cards">
            	...
            	<div class="card">
	                ...
	                <button class="btn btn-primary">
						<a style="color: white" href="index.jsp"> Ver Menu </a>
					</button>
                </div>
